...
from .models import Product, Category, Vendor, Tags, ProductReview, Cart, CartOrder, CartOrderItems, Payment
from core.serializers import ProductSerializer, CategorySerializer, VendorSerializer, ProductReviewSerializer, TagsSerializer, CartSerializer
    ...
    def post(self, request):
        ...
        try:
            ...
            payload = {
                ...
                "success_url": f"{backend_base}/payments/sslcommerz/success/",
                "fail_url": f"{backend_base}/payments/sslcommerz/fail/",
                "cancel_url": f"{backend_base}/payments/sslcommerz/cancel/",
                "ipn_url": f"{backend_base}/payments/sslcommerz/ipn/",
            ...
            if gateway_data.get("status") != "SUCCESS":
                ...
                return Response({
                    "error": gateway_data.get("failedreason")
                }, status=400)
    ...
    def post(self, request):
        ...
        try:
            ...
            if gateway_data.get("status") != "SUCCESS":
                ...
                return Response({
                    "error": gateway_data.get("failedreason", "Payment session failed")
                }, status=400)
